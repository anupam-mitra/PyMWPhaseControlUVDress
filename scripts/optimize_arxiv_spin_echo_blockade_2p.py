...
def main():
    parser = argparse.ArgumentParser(description='Optimize 2-photon blockade MS spin-echo passage')
    parser.add_argument('--t-start', type=float, default=20.0, help='Initial dimensionless Tbar')
    ...
    parser.add_argument('--md-out', type=str, default='results_blockade_2p.md', help='Markdown output file')
    parser.add_argument('--h5-out', type=str, default='results_blockade_2p.h5', help='HDF5 output file')
