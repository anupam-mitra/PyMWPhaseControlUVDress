...
- `HamiltonianBaseParameters`: Dictionary of nominal values for the Hamiltonian (e.g., Rabi frequencies, detunings).
...
2. **Hamiltonian** $\rightarrow$ Uses `HamiltonianBaseParameters` to build the matrices for each step.
