...
- **Rydberg Atoms**: Control of Rydberg state transitions, including complex dressing and undressing protocols, and high-fidelity Mølmer-Sørensen (MS) gate implementations using adiabatic Rydberg dressing.
...
- **Configuration Decoupling**: Use of YAML configuration files to separate physical parameters and regime settings (e.g., 1-photon vs 2-photon) from the optimization logic.
